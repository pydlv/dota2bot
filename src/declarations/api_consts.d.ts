...
declare const DAMAGE_TYPE_PHYSICAL;
declare const DAMAGE_TYPE_MAGICAL;
declare const DAMAGE_TYPE_PURE;
declare const DAMAGE_TYPE_ALL;

declare type DotaDamageType = DAMAGE_TYPE_PHYSICAL & DAMAGE_TYPE_MAGICAL & DAMAGE_TYPE_PURE & DAMAGE_TYPE_ALL;
